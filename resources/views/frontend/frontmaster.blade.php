...
<html lang="en">
  <head>
    ...
    <title>Mount Holiday-Inn Resort</title>
    <!--====== Favicon Icon ======-->
    ...
    <link rel="stylesheet" href="{{asset('landingpage/css/nivo-lightbox.css')}}">
  ...
  <body>
    ...
    <header id="home" class="hero-area">    
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#services">AboutUs</a>
              </li>  
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#features">Services</a>
              </li>                            
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#showcase">Rooms</a>
              </li>       
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#pricing">Banquets</a>
              </li>     
              <li class="nav-item">
      ...
      <div class="col-lg-6 col-md-12 col-xs-12 p-0">
        <div class="intro-img">
          <img src="{{url('landingpage/img/img1.png')}}" alt="" style="">
        </div>   
      <br>
      <br>
      <br>
...
<!-------------------------make reservaion-------------------------------------------------------->
      ...
      <div class="card" style="width: 30rem; ">
        <div class="card-body" style="background-color:rgb(25, 10, 57);">
          <h5 class="card-title" style="color:rgb(249, 162, 255) ">Make Reservation</h5>
      
                                    
              <div class="row">
                <div class="col-md-12">
                <label for="department" style="color: lavender"> Reservtion Type</label>
                <select class=" browser-default custom-select" name="edepartment" id="edepartment"  style="color:#4682B4" >
              ...
              <div class="input-daterange datepicker row align-items-center">
                <div class="col">
                  <label for="department" style="color: lavender"> Check-In-Date</label>
                ...
                <div class="col">
                  <label for="department" style="color: lavender"> Check-Out-Date</label>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
            ...
            <div class="input-daterange datepicker row align-items-center">
              <div class="col">
                <label for="department" style="color: lavender">Adults</label>
                  <div class="form-group">
                      <div class="input-group">
                      
                    
                       
                          <input class="form-control" type="text" style="background-color: rgb(207, 178, 235)">
                      </div>
                  </div>
              </div>
              <div class="col">
                <label for="department" style="color: lavender">Kids</label>
                  <div class="form-group">
                      <div class="input-group">
                          
                          <input class="form-control"  type="text" style="background-color: rgb(215, 184, 243)">
                      </div>
                  </div>
              </div>
          </div>

        <a data-id="exampleModalLabe"id="rommtypeaddmodal"class="btn btn-outline-primary" type="button" data-toggle="modal" data-target="#exampleModal">   <span class="btn-inner-icon" ><i class="fa fa-search"></i></span>Search</a>
        </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="pricing-text section-header text-center">  
              <div>   
                <h2 class="section-title">Banquets</h2>
                <div class="desc-text">
                  <p></p>
                </div>
              </div> 
        ...
        <div class="row pricing-tables">
          ...
          <div class="col-lg-4 col-md-4 col-xs-12">
            <div class="pricing-table text-center">
              <div class="pricing-details">
                <h3>Grand Swiss Hall</h3>
                <h1><span>$</span>40</h1>
                <img src="{{url('landingpage/img/img2.png')}}" alt="Bamboo Grove">
                <ul>
                <li>Capacity:400</li>
                  <li>Decorations free</li>
                  <li>Musical Band</li>
                  <li>Free Wi-fi</li>
                  <li>Ac</li>
              ...
              <div class="plan-button">
                <a href="#" class="btn btn-border">Book Now</a>
              </div>
            </div>
          </div>
           <!--  End Col -->
         <!--  Start Col -->
          <div class="col-lg-4 col-md-4 col-xs-12">
            <div class="pricing-table text-center">
              <div class="pricing-details">
                <h3>Super Deluxe Hall</h3>
                
                <h1><span>$</span>50.99</h1>
                <img src="{{url('landingpage/img/img3.png')}}" alt="Golden Banquet">
                <ul>
                <li>Capacity:400</li>
                  <li>Decorations free</li>
                  <li>Musical Band</li>
              ...
              <div class="plan-button">
                <a href="#" class="btn btn-common">Book Now</a>
              </div>
            </div>
          </div>
           <!--  End Col -->
         <!--  Start Col -->
          <div class="col-lg-4 col-md-4 col-xs-12">
            <div class="pricing-table text-center">
              <div class="pricing-details">
                <h3>Moon Hall</h3>
                <h1><span>$</span>45.99</h1>
                <img src="{{url('landingpage/img/img4.png')}}" alt="Bello Bee">
                <ul>
                  <li>Capacity:400</li>
                  <li>Decorations free</li>
                  <li>Musical Band</li>
    ...
    <script src="{{asset('landingpage/js/scrolling-nav.js')}}"></script>    
    <script src="{{asset('landingpage/js/jquery.easing.min.js')}}"></script>     
    <script src="{{asset('landingpage/js/nivo-lightbox.js')}}"></script>     
